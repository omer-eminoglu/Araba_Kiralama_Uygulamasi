    ...
    if ($odemeId) {
        ...
        if ($aracDetayId) {
            $rezervasyonQuery = "
                ...
                (arac_detay_id, arac_id, musteri_id, teslim_alinacak_tarih, teslim_alinacak_saat, teslim_edilecek_tarih, teslim_edilecek_saat, teslim_alinacak_sube_id, teslim_edilecek_sube_id, odeme_id, ucus_kodu) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
